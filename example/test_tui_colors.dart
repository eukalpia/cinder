  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 1),
        const Text('White on red bg',
            style: TextStyle(color: Colors.white, backgroundColor: Colors.red)),
        const Text('Black on green bg',
            style:
                TextStyle(color: Colors.black, backgroundColor: Colors.green)),
        const Text('Yellow on blue bg',
            style:
                TextStyle(color: Colors.yellow, backgroundColor: Colors.blue)),
        const SizedBox(height: 1),
        ...
        const SizedBox(height: 1),
        Text('RGB Color (255,128,0)',
            style: TextStyle(color: Color.fromRGB(255, 128, 0))),
        Text('RGB Color (128,0,255)',
