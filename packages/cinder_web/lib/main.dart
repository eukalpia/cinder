...
import 'package:cinder/cinder.dart' as cinder;
import 'package:cinder/cinder.dart' show WebBackend;
import 'package:google_fonts/google_fonts.dart';
import 'package:web/web.dart' as web;

void main() {
  runApp(const CinderWebApp());
}

class CinderWebApp extends StatelessWidget {
  const CinderWebApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'cinder Web Terminal',
...
class _TerminalPageState extends State<TerminalPage> {
  ...
  void _initializeHost() {
    ...
    WebBackend.setSize(cinder.Size(
    ...
    terminal.onResize = (width, height, pixelWidth, pixelHeight) {
      WebBackend.setSize(cinder.Size(width.toDouble(), height.toDouble()));
    };
  ...
  Future<void> _loadCinderApp() async {
    try {
