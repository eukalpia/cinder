...
We're excited to announce **Cinder v0.4.3**, the latest release of the Flutter-like TUI framework for Dart. This release focuses on rendering reliability, new widget capabilities, experimental image support, and improvements to the testing framework.
...
One of the most requested features is now available as an **experimental** API. Cinder can now render images directly in the terminal using protocols like Kitty and iTerm2 inline images.
...
> Image support is marked as experimental and the API may change in future releases. Terminal support varies — Kitty, iTerm2, and WezTerm offer the best experience. See the [documentation](https://github.com/eukalpia/cinder) for details.

## Testing Framework Updates

The `testCinder()` testing API has been refined based on community feedback. Key changes include:
...
The `TextField` widget has received several quality-of-life improvements:
...
- **Web target** — Compile cinder apps to run in a browser-based terminal (you can already see this on [cinder.dev](https://cinder.dev))

---

Thanks to everyone who contributed bug reports, pull requests, and feedback. If you run into issues, please [open an issue on GitHub](https://github.com/eukalpia/cinder/issues).
