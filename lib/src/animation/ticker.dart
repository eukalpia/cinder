...
/// its callback once per animation frame.
///
/// A [Ticker] can be silenced by setting [muted] to true. While muted, the
/// ticker remains "active" but its callback is not called.
class Ticker {
  /// Creates a [Ticker].
  ///
  /// The supplied callback will be called once per animation frame while the
  /// ticker is active.
  ...
  ///
  /// When muted, the ticker remains "active" but its callback is not
