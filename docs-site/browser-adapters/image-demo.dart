...
///
/// The adapter keeps the Cinder image renderer and protocol selector, but uses
/// deterministic in-memory RGBA pixels instead of pretending that the browser
/// can read an arbitrary local path.
void main() {
...
class _BrowserImageDemoState extends State<BrowserImageDemo> {
  ...
  final List<ImageProtocol> _protocols = const [
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: const [
                  ...
                  Text('RGBA MEMORY SOURCE', style: TextStyle(color: Colors.green)),
                ],
              ),
            ),
              ...
              child: Container(
                ...
                child: Image.rgba(
                  ...
                  errorWidget: const Center(
                    child: Text('Image adapter failed', style: TextStyle(color: Colors.red)),
                  ),
                ),
              ),
            ),
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  const Text('Tab / ← / → switch protocol', style: TextStyle(color: Colors.gray)),
                  Text(
