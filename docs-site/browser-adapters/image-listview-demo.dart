          ...
          Container(
            ...
            child: Row(
              ...
              children: const [
                ...
                Text('10 GENERATED RGBA SOURCES', style: TextStyle(color: Colors.green)),
              ],
            ),
          ),
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      border: BoxBorder(
                        bottom: BorderSide(color: Colors.gray.withOpacity(0.45)),
                      ),
                    ),
                    child: Row(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 1),
                              const Text(
                                'MemoryImage → decode → RenderImage → Unicode cells',
...
Uint8List _makePixels(int width, int height, int seed) {
  ...
  for (var y = 0; y < height; y++) {
    for (var x = 0; x < width; x++) {
      ...
      pixels[index + 2] = (70 + seed * 13 + y * 2).clamp(0, 255);
