...
class _ClipboardSandboxAppState extends State<ClipboardSandboxApp> {
  final List<String> _events = <String>[
    ...
    'The host OS clipboard is not read without browser permission.',
  ];
  int _sequence = 1;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'OSC 52 depends on the terminal host; browser permission APIs are outside this sandbox.',
