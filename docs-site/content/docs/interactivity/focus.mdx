...
Focus determines which widget receives keyboard input. This guide explains how to manage focus in your app.

## Focus system

Only one widget can have focus at a time. The focused widget receives all keyboard events.

```dart
Focusable(
  focused: true,  // This widget has focus
  onKeyEvent: (event) {
...
Show users which widget has focus:
...
Only one widget should have `focused: true`:
...
- [Testing](/docs/testing/basics) - Test your app
