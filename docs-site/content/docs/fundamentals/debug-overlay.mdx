...
When debug mode is active, Cinder enables the "repaint rainbow" effect. Widgets that repaint are briefly colored, showing you exactly which parts of your UI are updating.
