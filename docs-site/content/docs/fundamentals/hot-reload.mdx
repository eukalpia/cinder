...
Now just save your files. Cinder watches for changes and reloads automatically.
...
- [Layout](/docs/components/layout) - Build UIs with layout components
- [Text & Styling](/docs/components/text) - Style your text
