---
title: Animation
description: Flutter-like animation system for smooth, declarative animations in Cinder
icon: play
---

Cinder includes a complete animation system modeled after Flutter's. You can create smooth animations using `AnimationController`, `Tween`s, and `Curve`s to bring your terminal UIs to life.
...
This creates a widget that fades in over 500ms when added to the tree.
