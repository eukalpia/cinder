...
The `TerminalXterm` widget embeds a full terminal emulator to display subprocess output. This guide shows you how to use it.
...
```dart
class CommandRunner extends StatefulWidget {
