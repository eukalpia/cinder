...
`Focusable` makes any widget respond to keyboard input:
...
Events bubble up the widget tree until a handler returns `true`.
...
- [Keyboard Events](/docs/interactivity/keyboard) - Deep dive into keyboard handling
- [Focus Management](/docs/interactivity/focus) - Advanced focus patterns
- [Text & Styling](/docs/components/text) - Style your text input
