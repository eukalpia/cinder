...
Cinder handles many differences automatically by using widely-supported ANSI codes. When you use `TextStyle(color: Colors.red)`, Cinder picks an approach that works on most terminals.
...
Users resize terminal windows while your app runs. Cinder rebuilds your UI automatically when this happens, but you should:
...
Cinder supports mouse events when the terminal supports them, but your app shouldn't require them.
...
- [Components](/docs/fundamentals/components) - Build your UI with confidence
- [Testing](/docs/testing/basics) - Test across different scenarios
- [Keyboard Events](/docs/interactivity/keyboard) - Make your app keyboard-friendly
