...
Understanding a few terminal concepts will help you build better TUIs. This guide explains what happens when your Cinder app runs.
...
Cinder automatically switches to the alternate screen when you call `runApp()`. You don't need to do anything.
...
Cinder switches to raw mode when your app starts and restores cooked mode when it exits. You don't configure this manually.
...
When the user resizes the terminal, your app needs to redraw its UI. Cinder handles this automatically:
- It detects resize events
- Rebuilds your widget tree
...
When you use `Column`, `Row`, and other layout components, Cinder calculates positions in character cells and renders each cell with the correct character and style.

## What Cinder handles for you
...
Focus on building your UI. Cinder handles the terminal.

## Next steps

- [ANSI Escape Codes](/docs/terminal-concepts/ansi) - How terminals display colors and styles
- [Terminal Limitations](/docs/terminal-concepts/limitations) - Things to watch out for
- [Widgets](/docs/fundamentals/components) - Start building your UI
