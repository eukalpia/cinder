...
- Preserve navigator state while asynchronous terminal theme detection completes.
- Make test-frame settling terminate when the widget tree stops requesting frames.
