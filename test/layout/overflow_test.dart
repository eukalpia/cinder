...
void main() {
  group('Overflow Handling', () {
    test('horizontal overflow in constrained container', () async {
      await testCinder('horizontal overflow', (tester) async {
    ...
    test('vertical overflow in constrained container', () async {
      await testCinder('vertical overflow', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 20,
    ...
    test('combined horizontal and vertical overflow', () async {
      await testCinder('combined overflow', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
    ...
    test('overflow with nested containers', () async {
      await testCinder('nested overflow', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 30,
    ...
    test('overflow with flexible widgets', () async {
      await testCinder('flexible overflow', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
            height: 10,
