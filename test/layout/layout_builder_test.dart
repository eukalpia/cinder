  ...
  group('LayoutBuilder', () {
    group('constraint passing', () {
      test('receives terminal constraints at root', () async {
        await testCinder('terminal constraints at root', (tester) async {
      ...
      test('receives constraints from parent', () async {
        await testCinder('receives parent constraints', (tester) async {
          BoxConstraints? receivedConstraints;
      ...
      test('builder is called with BoxConstraints', () async {
        await testCinder('builder called with BoxConstraints', (tester) async {
          BoxConstraints? receivedConstraints;
          ...
          expect(
            receivedConstraints!.minWidth,
            equals(receivedConstraints!.maxWidth),
          );
          expect(
            receivedConstraints!.minHeight,
      ...
      test('context is a valid BuildContext', () async {
        await testCinder('valid build context', (tester) async {
    ...
    group('rendering', () {
      test('renders child from builder', () async {
        await testCinder('renders child', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
      ...
      test('renders complex child structures', () async {
        await testCinder('complex child', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
                return Column(
      ...
      test('nested LayoutBuilders render correctly', () async {
        await testCinder('nested LayoutBuilders', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
    ...
    group('rebuilding behavior', () {
      test('calls builder on initial build', () async {
        await testCinder('initial build', (tester) async {
          int buildCount = 0;
      ...
      test('rebuilds when parent state changes', () async {
        await testCinder('rebuilds on parent change', (tester) async {
          int buildCount = 0;
      ...
      test('rebuilds when builder function changes', () async {
        await testCinder('rebuilds when builder changes', (tester) async {
          int buildCount = 0;
    ...
    group('responsive layouts', () {
      ...
      test('can use height in layout decisions', () async {
        await testCinder('height-based layout', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
      ...
      test('can display constraint info', () async {
        await testCinder('display constraint info', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
                return Column(
    ...
    group('state preservation', () {
      test('stateful children preserve state across rebuilds', () async {
        await testCinder('preserves child state', (tester) async {
          await tester.pumpWidget(_StatePreservationTest());
    ...
    group('visual tests', () {
      test('visual: displays constraints info', () async {
        await testCinder('displays constraints info', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
                return Column(
      ...
      test('visual: responsive layout in action', () async {
        await testCinder('responsive layout visual', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return Column(
                  children: [
                    Text('Columns: $cols'),
                    Text(
                      'Available: ${constraints.maxWidth.toInt()}x'
      ...
      test('visual: adaptive dialog', () async {
        await testCinder('adaptive dialog visual', (tester) async {
          await tester.pumpWidget(
            Center(
              child: Container(
    ...
    group('edge cases', () {
      test('handles error in builder gracefully', () async {
        await testCinder('error handling in builder', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
      ...
      test('handles empty builder (returns empty Container)', () async {
        await testCinder('empty builder', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
                return Container();
      ...
      test('works inside Column', () async {
        await testCinder('inside Column', (tester) async {
          await tester.pumpWidget(
            Column(
              children: [
                const Text('Header'),
      ...
      test('works inside Row', () async {
        await testCinder('inside Row', (tester) async {
          await tester.pumpWidget(
            Row(
              children: [
                const Text('Left'),
      ...
      test('multiple LayoutBuilders in same tree', () async {
        await testCinder('multiple LayoutBuilders', (tester) async {
          await tester.pumpWidget(
            Row(
              children: [
                Expanded(
    ...
    group('with different terminal sizes', () {
      test('receives constraints matching small terminal', () async {
        await testCinder('small terminal', (tester) async {
          BoxConstraints? receivedConstraints;
      ...
      test('receives constraints matching large terminal', () async {
        await testCinder('large terminal', (tester) async {
          BoxConstraints? receivedConstraints;
      ...
      test('responsive layout adapts to terminal size', () async {
        await testCinder('adapts to small terminal', (tester) async {
          await tester.pumpWidget(
            LayoutBuilder(
              builder: (context, constraints) {
...
class _StatePreservationTestState extends State<_StatePreservationTest> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        return Column(children: [Text('Version: $_version'), const _Counter()]);
      },
    );
  }
}
