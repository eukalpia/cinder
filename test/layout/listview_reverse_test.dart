...
void main() {
  group('ListView reverse', () {
    test('renders items from bottom to top when reverse is true', () async {
      await testCinder('reverse vertical ListView', (tester) async {
    ...
    test(
      'renders items from right to left when reverse is true and horizontal',
      () async {
        await testCinder('reverse horizontal ListView', (tester) async {
          await tester.pumpWidget(
            SizedBox(
              width: 30,
              height: 5,
    ...
    test('normal ListView renders from top to bottom', () async {
      await testCinder('normal vertical ListView', (tester) async {
        await tester.pumpWidget(
          SizedBox(
            width: 20,
            height: 10,
    ...
    test('ListView.builder with reverse', () async {
      await testCinder('reverse ListView.builder', (tester) async {
        await tester.pumpWidget(
          SizedBox(
            width: 20,
            height: 10,
    ...
    test('ListView.separated with reverse', () async {
      await testCinder('reverse ListView.separated', (tester) async {
        await tester.pumpWidget(
          SizedBox(
            width: 20,
            height: 15,
