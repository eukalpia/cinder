...
void main() {
  group('Stack Interactive Demo', () {
    test('visual test - initial state', () async {
      await testCinder('initial rendering', (tester) async {
    ...
    test('counter interaction', () async {
      await testCinder('counter up/down', (tester) async {
        await tester.pumpWidget(const StackInteractiveDemo());
    ...
    test('item selection', () async {
      await testCinder('select items with number keys', (tester) async {
        await tester.pumpWidget(const StackInteractiveDemo());
    ...
    test('overlay toggle', () async {
      await testCinder('toggle overlay with O key', (tester) async {
        await tester.pumpWidget(const StackInteractiveDemo());
    ...
    test('combined interactions', () async {
      await testCinder('test multiple features together', (tester) async {
        await tester.pumpWidget(const StackInteractiveDemo());
