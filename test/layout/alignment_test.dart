...
void main() {
  group('Text Alignment', () {
    test('center alignment', () async {
      await testCinder('center aligned text', (tester) async {
    ...
    test('left alignment', () async {
      await testCinder('left aligned text', (tester) async {
        await tester.pumpWidget(
          DecoratedBox(
            decoration: BoxDecoration(
              border: BoxBorder.all(
    ...
    test('right alignment', () async {
      await testCinder('right aligned text', (tester) async {
        await tester.pumpWidget(
          DecoratedBox(
            decoration: BoxDecoration(
              border: BoxBorder.all(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: const [Text('Center'), Text('✨')],
                  ),
                ),
                SizedBox(width: 1),
                // Left alignment
