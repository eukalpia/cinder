...
void main() {
  group('Text Centering', () {
    test('mathematical centering proof', () async {
      await testCinder('centering proof', (tester) async {
    ...
    test('visual centering with emojis', () async {
      await testCinder('visual centering', (tester) async {
        await tester.pumpWidget(
          Center(
            child: DecoratedBox(
              decoration: BoxDecoration(
    ...
    test('centering in different width containers', () async {
      await testCinder('different widths', (tester) async {
        await tester.pumpWidget(
          Row(
            children: [
              // Narrow container
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [Text('Short'), Text('✨')],
                ),
              ),
              SizedBox(width: 1),
              // Medium container
              Container(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [Text('Medium text'), Text('✨ Emoji')],
                ),
              ),
              SizedBox(width: 1),
              // Wide container
              Container(
                ...
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [Text('Wide text'), Text('✨ Wide')],
                ),
              ),
            ],
          ),
    ...
    test('centering with padding', () async {
      await testCinder('centering with padding', (tester) async {
        await tester.pumpWidget(
          Center(
            child: DecoratedBox(
              decoration: BoxDecoration(
    ...
    test('ruler alignment test', () async {
      await testCinder('ruler alignment', (tester) async {
        await tester.pumpWidget(
          DecoratedBox(
            decoration: BoxDecoration(
