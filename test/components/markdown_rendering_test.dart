...
void main() {
  group('MarkdownText Line Breaks', () {
    test('renders paragraphs with proper spacing', () async {
      await testCinder('paragraph spacing', (tester) async {
...
Third paragraph.'''),
    ...
    test('renders headers with proper line breaks', () async {
      await testCinder('header line breaks', (tester) async {
        await tester.pumpWidget(
...
More text here.'''),
    ...
    test('renders lists with proper formatting', () async {
      await testCinder('list formatting', (tester) async {
        await tester.pumpWidget(
...
Text after list.'''),
    ...
    test('renders code blocks with proper spacing', () async {
      await testCinder('code block spacing', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 50,
...
Text after code.'''),
    ...
    test('handles mixed content correctly', () async {
      await testCinder('mixed content', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 60,
...
Final paragraph.'''),
    ...
    test('check exact line structure', () async {
      await testCinder('exact line structure', (tester) async {
        await tester.pumpWidget(
          Container(
