...
void main() {
  group('Divider', () {
    test('visual development - horizontal divider', () async {
      await testCinder('see how horizontal divider looks', (tester) async {
    ...
    test('visual development - divider styles', () async {
      await testCinder('different divider styles', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
            height: 20,
    ...
    test('visual development - divider with indents', () async {
      await testCinder('divider with indents', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
            height: 10,
    ...
    test('visual development - colored dividers', () async {
      await testCinder('colored dividers', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
            height: 12,
    ...
    test('visual development - vertical divider', () async {
      await testCinder('vertical divider', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 50,
            height: 10,
    ...
    test('renders horizontal divider correctly', () async {
      await testCinder('horizontal divider rendering', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 20,
            height: 5,
            child: Column(children: [Text('Top'), Divider(), Text('Bottom')]),
          ),
        );
    ...
    test('renders vertical divider correctly', () async {
      await testCinder('vertical divider rendering', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 30,
            height: 5,
            child: Row(
              children: [Text('Left'), VerticalDivider(), Text('Right')],
            ),
          ),
        );
    ...
    test('applies indents correctly', () async {
      await testCinder('divider indents', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 30,
            height: 3,
    ...
    test('different styles render correctly', () async {
      await testCinder('divider styles', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 20,
            height: 2,
      ...
      await testCinder('ascii divider style', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 20,
            height: 2,
    ...
    test('applies colors correctly', () async {
      await testCinder('colored divider', (tester) async {
        await tester.pumpWidget(
          Container(width: 20, height: 2, child: Divider(color: Colors.red)),
        );
