...
void main() {
  group('Text Alignment Visual Tests', () {
    test('text alignment in constrained container', () async {
      await testCinder('text alignment rendering', (tester) async {
          ...
          Container(
            ...
            child: Column(
              children: const [
                ...
                Text('Short'),
                Text(
                  'This is a longer text that wraps',
    ...
    test('text alignment with different widths', () async {
      await testCinder('alignment at various widths', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
    ...
    test('justified text alignment', () async {
      await testCinder('justified text', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 30,
            decoration: BoxDecoration(
            ...
            child: Column(
              children: const [
                ...
                SizedBox(height: 1),
                Text('Short line', textAlign: TextAlign.justify),
              ],
            ),
          ),
        );
    ...
    test('text alignment with padding', () async {
      await testCinder('alignment with padding', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 30,
