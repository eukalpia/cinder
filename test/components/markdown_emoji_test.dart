...
void main() {
  group('Markdown Emoji Rendering', () {
    test('renders text with emojis correctly aligned', () async {
      await testCinder('markdown with emojis', (tester) async {
    ...
    test('renders multiple emojis in a row', () async {
      await testCinder('multiple emojis', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 30,
    ...
    test('renders markdown bold with emojis', () async {
      await testCinder('bold with emojis', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
    ...
    test('renders markdown list with emojis', () async {
      await testCinder('list with emojis', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
            child: const MarkdownText(
    ...
    test('renders markdown header with emoji', () async {
      await testCinder('header with emoji', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
    ...
    test('renders emoji alignment in boxed container', () async {
      await testCinder('emoji in box', (tester) async {
        await tester.pumpWidget(
          Center(
            child: DecoratedBox(
    ...
    test('renders complex emoji sequences', () async {
      await testCinder('complex emoji', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 50,
            child: const MarkdownText(
    ...
    test('renders emoji at different positions', () async {
      await testCinder('emoji positions', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 40,
            child: const MarkdownText(
