...
void main() {
  group('ProgressBar', () {
    test('visual development - basic progress bar', () async {
      await testCinder('basic progress bar at different values', (
        tester,
      ) async {
        print('Progress at 0%:');
    ...
    test('visual development - progress bar with borders', () async {
      await testCinder('progress bars with different border styles', (
        tester,
      ) async {
        print('Single border:');
        await tester.pumpWidget(
    ...
    test('visual development - progress bar with percentage', () async {
      await testCinder('progress bar showing percentage', (tester) async {
    ...
    test('visual development - custom characters', () async {
      await testCinder('progress bar with custom fill characters', (
        tester,
      ) async {
    ...
    test('visual development - progress bar with labels', () async {
      await testCinder('progress bar with custom labels', (tester) async {
    ...
    test('visual development - indeterminate progress', () async {
      await testCinder('indeterminate progress animation', (tester) async {
    ...
    test('renders correctly', () async {
      await testCinder('correct rendering', (tester) async {
        await tester.pumpWidget(
          SizedBox(width: 20, height: 1, child: ProgressBar(value: 0.5)),
        );
    ...
    test('handles different sizes', () async {
      await testCinder('different sizes', (tester) async {
        // Small progress bar
        await tester.pumpWidget(
          SizedBox(width: 10, height: 1, child: ProgressBar(value: 0.5)),
        );
