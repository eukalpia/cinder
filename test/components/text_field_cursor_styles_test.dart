...
void main() {
  group('TextField Cursor Styles', () {
    ...
    test('cursor renders correctly at different positions', () async {
      await testCinder('cursor position test', (tester) async {
    ...
    test('empty field shows cursor correctly', () async {
      await testCinder('empty field cursor test', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
    ...
    test('cursor style changes dynamically', () async {
      await testCinder('dynamic cursor style test', (tester) async {
    ...
    test('non-blinking cursor', () async {
      await testCinder('non-blinking cursor test', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
              Text(
