...
void main() {
  group('TextField clipboard integration', () {
    ...
    test('copy selected text with Ctrl+C', () async {
      await testCinder('TextField copy test', (tester) async {
    ...
    test('cut selected text with Ctrl+X', () async {
      await testCinder('TextField cut test', (tester) async {
    ...
    test('paste text with Ctrl+V', () async {
      await testCinder('TextField paste test', (tester) async {
    ...
    test('paste replaces selected text', () async {
      await testCinder('TextField paste replaces selection', (tester) async {
    ...
    test('cut-paste workflow', () async {
      await testCinder('TextField cut-paste workflow', (tester) async {
    ...
    test('paste handles Unicode correctly', () async {
      await testCinder('TextField paste Unicode', (tester) async {
        final controller = TextEditingController(text: '');
    ...
    test('paste handles multi-line text in single-line field', () async {
      await testCinder('TextField paste multi-line in single-line field', (
        tester,
      ) async {
        final controller = TextEditingController(text: '');
