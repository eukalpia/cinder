...
void main() {
  group('TextField Selection', () {
    test('selection should be visible when using Shift+Arrow keys', () async {
      await testCinder('text selection rendering', (tester) async {
    ...
    test('Ctrl+A should select all text', () async {
      await testCinder('select all functionality', (tester) async {
    ...
    test('typing should replace selected text', () async {
      await testCinder('replace selection with typed text', (tester) async {
    ...
    test('visual selection highlighting', () async {
      await testCinder('check selection background color', (tester) async {
