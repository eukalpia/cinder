...
void main() {
  group('RenderParagraph Selection', () {
    ...
    test('partial selection within styled spans', () async {
      await testCinder('partial styled selection', (tester) async {
        String? completed;
    ...
    test('multi-widget selection with RichText and Text', () async {
      await testCinder('multi-widget selection', (tester) async {
        String? completed;
    ...
    test('wrapped RichText selection', () async {
      await testCinder('wrapped rich text selection', (tester) async {
        String? completed;
    ...
    test('selection with multiline content', () async {
      await testCinder('multiline content selection', (tester) async {
        String? completed;
    ...
    test('selection clears when RichText content changes', () async {
      await testCinder('selection clears on change', (tester) async {
        String? lastChanged;
        ...
        await tester.pumpWidget(
          Container(
            ...
            child: SelectionArea(
              ...
              child: RichText(text: const TextSpan(text: 'Original')),
            ),
          ),
        );
        ...
        await tester.pumpWidget(
          Container(
            ...
            child: SelectionArea(
              onSelectionChanged: (text) => lastChanged = text,
              child: RichText(text: const TextSpan(text: 'Changed')),
            ),
          ),
        );
    ...
    test('multiple RichText widgets in selection', () async {
      await testCinder('multiple rich text selection', (tester) async {
        String? completed;
    ...
    test('RichText selectableText returns plain text', () async {
      await testCinder('selectableText getter', (tester) async {
        await tester.pumpWidget(
          RichText(
            text: const TextSpan(
              children: [
    ...
    test('RichText selectableLayout returns layout result', () async {
      await testCinder('selectableLayout getter', (tester) async {
        await tester.pumpWidget(
          Container(
            width: 20,
            child: RichText(text: const TextSpan(text: 'Hello World')),
          ),
        );
        ...
        expect(renderParagraph!.selectableLayout!.lines.length, greaterThan(0));
      });
    });
  });
}
