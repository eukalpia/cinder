...
void main() {
  group('RichText', () {
    test('renders simple text span', () async {
      await testCinder('simple text span', (tester) async {
    ...
    test('renders nested text spans with different styles', () async {
      await testCinder('nested text spans', (tester) async {
        await tester.pumpWidget(
          RichText(
            text: const TextSpan(
              children: [
    ...
    test('renders colored text spans', () async {
      await testCinder('colored text spans', (tester) async {
        await tester.pumpWidget(
          RichText(
            text: const TextSpan(
              children: [
    ...
    test('handles text wrapping', () async {
      await testCinder('text wrapping', (tester) async {
        await tester.pumpWidget(
          Align(
    ...
    test('handles mixed styles with backgrounds', () async {
      await testCinder('mixed styles with backgrounds', (tester) async {
        await tester.pumpWidget(
          RichText(
            text: const TextSpan(
              children: [
    ...
    test('respects text alignment', () async {
      await testCinder('text alignment', (tester) async {
        await tester.pumpWidget(
          Align(
            alignment: Alignment.topLeft,
            child: Container(
    ...
    test('handles overflow with ellipsis', () async {
      await testCinder('overflow with ellipsis', (tester) async {
        await tester.pumpWidget(
          Align(
            alignment: Alignment.topLeft,
            child: Container(
    ...
    test('handles max lines constraint', () async {
      await testCinder('max lines constraint', (tester) async {
        await tester.pumpWidget(
          Align(
            alignment: Alignment.topLeft,
            child: Container(
