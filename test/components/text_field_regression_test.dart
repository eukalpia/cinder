...
void main() {
  group('TextField Regression Tests', () {
    test('single-line field still works correctly', () async {
      await testCinder('single-line', (tester) async {
        ...
        await tester.pumpWidget(
          TextField(
            ...
            width: 20,
            autofocus: true,
            decoration: const InputDecoration(border: BoxBorder()),
            showCursor: true,
    ...
    test('multi-line field with explicit newlines works', () async {
      await testCinder('explicit newlines', (tester) async {
    ...
    test('cursor position is correct after text changes', () async {
      await testCinder('cursor after text change', (tester) async {
