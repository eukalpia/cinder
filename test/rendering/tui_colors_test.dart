...
void main() {
  group('TUI Color Rendering', () {
    test('basic foreground colors', () async {
      await testCinder('foreground colors', (tester) async {
    ...
    test('background colors', () async {
      await testCinder('background colors', (tester) async {
        await tester.pumpWidget(
          Column(
            children: const [
              Text(
    ...
    test('text styles', () async {
      await testCinder('text styles', (tester) async {
        await tester.pumpWidget(
          Column(
            children: const [
    ...
    test('RGB colors', () async {
      await testCinder('RGB colors', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
              Text(
    ...
    test('combined styles', () async {
      await testCinder('combined styles', (tester) async {
        await tester.pumpWidget(
          Column(
            children: const [
              Text(
    ...
    test('color in containers', () async {
      await testCinder('colors in containers', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
              Container(
