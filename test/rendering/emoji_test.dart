...
void main() {
  group('Emoji Rendering', () {
    test('emoji width handling', () async {
      await testCinder('emoji width', (tester) async {
    ...
    test('emoji alignment in centered text', () async {
      await testCinder('emoji alignment centered', (tester) async {
        await tester.pumpWidget(
          Center(
            child: DecoratedBox(
              decoration: BoxDecoration(
        ...
        expect(tester.terminalState, containsText('Widget-based architecture'));
        expect(
          tester.terminalState,
    ...
    test('emoji in different alignments', () async {
      await testCinder('emoji alignments', (tester) async {
        await tester.pumpWidget(
          Row(
            children: [
    ...
    test('sparkles width calculation', () async {
      await testCinder('sparkles width', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
    ...
    test('emoji border rendering', () async {
      await testCinder('emoji with borders', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
