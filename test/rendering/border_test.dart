...
void main() {
  group('Border Rendering', () {
    test('minimum width border containers', () async {
      await testCinder('minimum width borders', (tester) async {
    ...
    test('different border widths', () async {
      await testCinder('border widths', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
    ...
    test('nested borders', () async {
      await testCinder('nested borders', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 30,
    ...
    test('borders with different colors', () async {
      await testCinder('colored borders', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
              Container(
    ...
    test('border with background color', () async {
      await testCinder('border with background', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 25,
    ...
    test('asymmetric border containers', () async {
      await testCinder('asymmetric borders', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
              // Very wide and short
