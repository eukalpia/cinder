...
void main() {
  group('Comprehensive Emoji Border Tests', () {
    ...
    test('face emojis in bordered container', () async {
      await testCinder('face emojis border test', (tester) async {
    ...
    test('hand emojis in bordered container', () async {
      await testCinder('hand emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('heart emojis in bordered container', () async {
      await testCinder('heart emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 50,
    ...
    test('animal emojis in bordered container', () async {
      await testCinder('animal emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('food emojis in bordered container', () async {
      await testCinder('food emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('weather emojis in bordered container', () async {
      await testCinder('weather emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 50,
    ...
    test('object emojis in bordered container', () async {
      await testCinder('object emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('symbol emojis in bordered container', () async {
      await testCinder('symbol emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 50,
    ...
    test('checkmark and status emojis in bordered container', () async {
      await testCinder('checkmark emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('arrow emojis in bordered container', () async {
      await testCinder('arrow emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('flag emojis in bordered container', () async {
      await testCinder('flag emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 45,
    ...
    test('ZWJ family emojis in bordered container', () async {
      await testCinder('ZWJ family emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 50,
    ...
    test('skin tone modifier emojis in bordered container', () async {
      await testCinder('skin tone emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 45,
    ...
    test('emoji grid - each in own border', () async {
      await testCinder('emoji grid border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
    ...
    test('emoji with text alignment', () async {
      await testCinder('emoji text alignment border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Column(
              mainAxisSize: MainAxisSize.min,
    ...
    test('stress test - many emojis in one container', () async {
      await testCinder('stress test many emojis border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 70,
    ...
    test('complex emojis in nested borders', () async {
      await testCinder('complex emojis nested borders test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 55,
    ...
    test('single emoji per line in tight border', () async {
      await testCinder('single emoji per line border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 8,
    ...
    test('emoji at start, middle, and end of text', () async {
      await testCinder('emoji position border test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 40,
    ...
    test('double border with emojis', () async {
      await testCinder('double border emoji test', (tester) async {
        await tester.pumpWidget(
          Center(
            child: Container(
              width: 45,
