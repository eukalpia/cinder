...
void main() {
  group('Tint widget', () {
    test('Tint dims child content', () async {
      await testCinder('tint dims content', (tester) async {
    ...
    test('Tint with zero alpha has no effect', () async {
      await testCinder('transparent tint', (tester) async {
        ...
        await tester.pumpWidget(
          Tint(
            ...
            child: Container(
              color: Colors.blue,
              child: Text('Hello', style: TextStyle(color: Colors.cyan)),
            ),
          ),
        );
    ...
    test('Tint can apply colored overlay', () async {
      await testCinder('colored tint', (tester) async {
        // Apply a red tint
        await tester.pumpWidget(
          Tint(
  ...
  group('ColoredBox (legacy)', () {
    test('ColoredBox with alpha uses applyTint', () async {
      await testCinder('coloredbox tint', (tester) async {
