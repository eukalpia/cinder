...
void main() {
  group('SIGINT (Ctrl+C) handling', () {
    test('widget can intercept Ctrl+C', () async {
      ...
      await testCinder('intercept ctrl+c', (tester) async {
    ...
    test('unhandled Ctrl+C should trigger shutdown', () async {
      ...
      await testCinder('fallback to shutdown', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('Ctrl+C has correct event properties', () async {
      ...
      await testCinder('event properties', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('only focused widget receives Ctrl+C', () async {
      ...
      await testCinder('focus respects routing', (tester) async {
        await tester.pumpWidget(
          Column(
            children: [
              Focusable(
    ...
    test('child can prevent parent from seeing Ctrl+C', () async {
      ...
      await testCinder('event bubbling', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('press twice pattern works', () async {
      ...
      await testCinder('press twice pattern', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('counter resets on other key press', () async {
      ...
      await testCinder('counter reset', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('Ctrl+C without ctrl modifier is just regular C', () async {
      ...
      await testCinder('distinguish ctrl+c from c', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('nested focused components - child handles before parent', () async {
      ...
      await testCinder('handler precedence', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('multiple modifiers with Ctrl+C', () async {
      ...
      await testCinder('ctrl+shift+c', (tester) async {
        await tester.pumpWidget(
          Focusable(
            focused: true,
            onKeyEvent: (event) {
    ...
    test('stateful widget with Ctrl+C counter', () async {
      await testCinder('stateful counter', (tester) async {
    ...
    test('Ctrl+C in unfocused widget should not be handled', () async {
      ...
      await testCinder('unfocused no handling', (tester) async {
        await tester.pumpWidget(
          Focusable(
