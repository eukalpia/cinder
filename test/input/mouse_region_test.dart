...
void main() {
  group('MouseRegion', () {
    test('visual development - hover visualization', () async {
      await testCinder('hover visualization', (tester) async {
    ...
    test('triggers onEnter when mouse enters', () async {
      await testCinder('onEnter callback', (tester) async {
        bool entered = false;
        int enterX = -1;
        int enterY = -1;
    ...
    test('triggers onExit when mouse leaves', () async {
      await testCinder('onExit callback', (tester) async {
        bool exited = false;
        int exitX = -1;
        int exitY = -1;
    ...
    test('triggers onHover when mouse moves inside', () async {
      await testCinder('onHover callback', (tester) async {
        int hoverCount = 0;
        int lastX = -1;
        int lastY = -1;
    ...
    test('does not trigger callbacks outside region', () async {
      await testCinder('no callbacks outside region', (tester) async {
        bool entered = false;
        bool hovered = false;
    ...
    test('respects opaque flag for hit testing', () async {
      await testCinder('opaque hit testing', (tester) async {
    ...
    test('nested MouseRegions trigger correctly', () async {
      await testCinder('nested regions', (tester) async {
