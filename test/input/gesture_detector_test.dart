...
void main() {
  group('GestureDetector', () {
    test('visual development - tap visualization', () async {
      await testCinder('tap visualization', (tester) async {
    ...
    test('triggers onTap on click', () async {
      await testCinder('onTap callback', (tester) async {
        int tapCount = 0;
    ...
    test('triggers onTapDown and onTapUp', () async {
      await testCinder('onTapDown and onTapUp callbacks', (tester) async {
    ...
    test('triggers onDoubleTap on double click', () async {
      await testCinder('onDoubleTap callback', (tester) async {
    ...
    test('triggers onLongPress when held', () async {
      await testCinder('onLongPress callback', (tester) async {
    ...
    test('does not trigger onTap outside detector', () async {
      await testCinder('no tap outside', (tester) async {
        int tapCount = 0;
    ...
    test('HitTestBehavior.deferToChild defers to child', () async {
      await testCinder('deferToChild behavior', (tester) async {
        int outerTaps = 0;
        int innerTaps = 0;
    ...
    test('HitTestBehavior.opaque blocks hits behind', () async {
      await testCinder('opaque behavior', (tester) async {
        int topTaps = 0;
        int bottomTaps = 0;
    ...
    test('onLongPressStart and onLongPressEnd callbacks', () async {
      await testCinder('long press start and end', (tester) async {
